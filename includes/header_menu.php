...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand">Virtual X</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">Front End</a>
                                   <a href="products.php#shirt" class="dropdown-item">App Developement</a>
                                   <a href="products.php#shoes" class="dropdown-item">Full Stack</a>
                                   <a href="products.php#headphones" class="dropdown-item">Backend</a>
                               </div>
